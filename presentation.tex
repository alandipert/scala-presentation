...
\uncover<1->{\}}
\uncover<2->{}
\uncover<2->{class Student(val school:String, name:String, age:Int) extends Person(name,age) \{}
...
\uncover<1->{\}}
\uncover<1->{}
\uncover<1->{class Student(val school:String, name:String, age:Int) extends Person(name,age) \{}
